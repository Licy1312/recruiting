 ...
 * 
 * @see com.corlymeng.model.Project
...
public class ProjectDAO {
	...
	public Project findById(java.lang.Integer id) {
		...
		try {
			Project instance = (Project) getCurrentSession().get(
					"com.corlymeng.model.Project", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Project> findByExample(Project instance) {
		...
		try {
			List<Project> results = (List<Project>) getCurrentSession()
					.createCriteria("com.corlymeng.model.Project")
	...
	public List<Project> findByIntro(Object intro) {
		return findByProperty(INTRO, intro);
	}

	public List<Project> findByUserid(Object userid) {
