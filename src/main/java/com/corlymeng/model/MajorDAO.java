...
public class MajorDAO {
	...
	public List<Major> findByExample(Major instance) {
		...
		try {
			List<Major> results = (List<Major>) getCurrentSession()
					.createCriteria("com.corlymeng.model.Major")
	...
	public List<Major> findByParentid(Object parentid) {
		return findByProperty(PARENTID, parentid);
	}

	public List<Major> findByOrder(Object order) {
