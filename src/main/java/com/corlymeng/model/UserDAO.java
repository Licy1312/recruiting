...
public class UserDAO {
	...
	public List<User> findByExample(User instance) {
		...
		try {
			List<User> results = (List<User>) getCurrentSession()
					.createCriteria("com.corlymeng.model.User")
	...
	public User findByEmail(Object email) {
		if(findByProperty(USERNAME, email).size()==0)
			return null;
		else
			return (User) findByProperty(USERNAME, email).get(0);
	}
	...
	public List<User> findByHighestEducation(Object highestEducation) {
		return findByProperty(HIGHEST_EDUCATION, highestEducation);
	}
	...
	public List<User> findByFilename(Object filename) {
		return findByProperty(FILENAME, filename);
	}

	public List<User> findByFilepath(Object filepath) {
